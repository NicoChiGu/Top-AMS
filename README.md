...
- 当前仓库保留 Bambu Studio 自带的 A1 mini 机器启动 G-code，只完整替换换料 G-code；`A1mini快速启动.gcode` 不是 Top-AMS 专用首料脚本
- 推荐使用
...
- 当前代码将热床目标温度 **1~16°C** 视为通道信号保留范围；逻辑通道为1~8，实际可用数量取决于4/6/8通道构建
